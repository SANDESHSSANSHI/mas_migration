...
const TableDataView = () => {
  ...
  useEffect(() => {
    ...
    fetch(`https://backend-open-db.apps.itz-47ubpb.infra01-lb.dal14.techzone.ibm.com${apiPrefix}/${schema}/${table}`)
      .then((res) => res.json())
      .then(setData)
      .catch(console.error)
  ...
  const handleMigrateTable = async () => {
    ...
    try {
      const res = await fetch(
        `https://backend-open-db.apps.itz-47ubpb.infra01-lb.dal14.techzone.ibm.com${apiPrefix}/${schema}/${table}/migrate`,
        {
          method: "POST",
        }
      );
