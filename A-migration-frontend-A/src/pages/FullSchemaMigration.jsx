...
const FullSchemaMigration = () => {
  ...
  const handleMigrateSchema = () => {
    ...
    const eventSourceUrl = `https://backend-open-db.apps.itz-47ubpb.infra01-lb.dal14.techzone.ibm.com/full-migration/all/stream?source_type=${sourceDbType}&schema=${selectedSchema}&transaction_id=${transactionId}`;
