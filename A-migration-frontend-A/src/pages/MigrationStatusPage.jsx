...
const MigrationStatusPage = () => {
  ...
  useEffect(() => {
    if (!currentMigration) {
      axios
        .get("https://backend-open-db.apps.itz-47ubpb.infra01-lb.dal14.techzone.ibm.com/current-migration")
  ...
  useEffect(() => {
    ...
    const fetchStatus = () => {
      axios
        .get(`https://backend-open-db.apps.itz-47ubpb.infra01-lb.dal14.techzone.ibm.com/migration-status/${currentMigration.transaction_id}`, {
          params: {
