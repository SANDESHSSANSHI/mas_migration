...
const AccountSettings = () => {
  ...
  useEffect(() => {
    const validateSession = async () => {
      try {
        const res = await fetch("https://backend-open-db.apps.itz-47ubpb.infra01-lb.dal14.techzone.ibm.com/auth/account", {
          credentials: "include",
        });
  ...
  const handlePasswordUpdate = async () => {
    ...
    try {
      const res = await fetch("https://backend-open-db.apps.itz-47ubpb.infra01-lb.dal14.techzone.ibm.com/auth/account/change-password", {
        method: "POST",
        credentials: "include",
        headers: {
